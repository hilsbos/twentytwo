...
function HandsElevatedPushupArt() {
  return (
    ...
    >
      ...
      {/* pose A — top (arms straight). Hands on the edge top (y=84); body is ONE
          STRAIGHT head-UP plank (shoulders high right, feet low on the floor):
          shoulder(150,54) -> hip(108,71) -> knee(82,82) -> ankle(58,92) collinear. */}
      <g className="pose-a">
        {/* arm: shoulder(150,54) straight down to hand on the edge(152,84) */}
        <line x1={150} y1={54} x2={152} y2={84} />
        {/* straight body plank (no hip pike): shoulder -> hip -> knee -> ankle */}
        <line x1={150} y1={54} x2={108} y2={71} />
        <line x1={108} y1={71} x2={82} y2={82} />
        <line x1={82} y1={82} x2={58} y2={92} />
        {/* FOOT TICK: toe planted forward on the floor, clearly angled off the shin */}
        <line x1={58} y1={92} x2={49} y2={94} />
        ...
        <circle cx={108} cy={71} r={2.5} fill="currentColor" stroke="none" />
        <circle cx={82} cy={82} r={2.5} fill="currentColor" stroke="none" />
      </g>

      {/* pose B — bottom (elbow bent deeper, chest dropped toward the edge). Body
          stays ONE STRAIGHT head-up plank, just flatter (rotated down about the
          feet): shoulder(146,80) -> hip(106,91) -> knee(80,98) -> ankle(56,104). */}
      <g className="pose-b">
        {/* arm: shoulder(146,80) -> elbow(165,79) -> hand on edge(152,84) */}
        <line x1={146} y1={80} x2={165} y2={79} />
        <line x1={165} y1={79} x2={152} y2={84} />
        {/* straight body plank (no hip pike), flatter */}
        <line x1={146} y1={80} x2={106} y2={91} />
        <line x1={106} y1={91} x2={80} y2={98} />
        <line x1={80} y1={98} x2={56} y2={104} />
        {/* FOOT TICK: toe planted forward on the floor */}
        <line x1={56} y1={104} x2={47} y2={106} />
        {/* neck + head */}
        ...
        <circle cx={106} cy={91} r={2.5} fill="currentColor" stroke="none" />
...
function DeclinePushupArt() {
  return (
    ...
    >
      ...
      <g opacity={0.6}>
        <path d="M 170 90 L 170 104" strokeWidth={2} strokeDasharray="4 3" />
        <path d="M 164 98 L 170 104 L 176 98" strokeWidth={2} />
      </g>

      {/* pose A — top. Hands on floor (right), feet UP on the tall block (left).
          Body is ONE STRAIGHT head-down plank: ankle(52,46) -> knee(70,54) ->
          hip(96,65) -> shoulder(140,84) are all collinear (no hip pike). */}
      <g className="pose-a">
        {/* arm: shoulder(140,84) straight down to hand(140,110) */}
        <line x1={140} y1={84} x2={140} y2={110} />
        {/* straight body plank, shoulder -> hip -> knee -> ankle (collinear) */}
        <line x1={140} y1={84} x2={96} y2={65} />
        <line x1={96} y1={65} x2={70} y2={54} />
        <line x1={70} y1={54} x2={52} y2={46} />
        {/* FOOT TICK: toe kicks UP off the block edge (clearly angled away from the
            shin line) so the leg reads as a leg, not a continuing arm */}
        <line x1={52} y1={46} x2={48} y2={37} />
        {/* neck + head, head down toward floor */}
        <line x1={140} y1={84} x2={150} y2={88} />
        <circle cx={155} cy={92} r={7} />
        {/* joint dots: shoulder, hip, knee */}
        <circle cx={140} cy={84} r={2.5} fill="currentColor" stroke="none" />
        <circle cx={96} cy={65} r={2.5} fill="currentColor" stroke="none" />
        <circle cx={70} cy={54} r={2.5} fill="currentColor" stroke="none" />
      </g>

      {/* pose B — bottom (elbow bent, head dropped near the floor). Body stays ONE
          STRAIGHT plank pivoting about the feet: ankle(52,46) -> knee(70,57) ->
          hip(96,72) -> shoulder(140,98) collinear (no hip pike). */}
      <g className="pose-b">
        {/* arm: shoulder(140,98) -> elbow(152,102) -> hand(140,110) */}
        <line x1={140} y1={98} x2={152} y2={102} />
        <line x1={152} y1={102} x2={140} y2={110} />
        {/* straight body plank, shoulder -> hip -> knee -> ankle (collinear) */}
        <line x1={140} y1={98} x2={96} y2={72} />
        <line x1={96} y1={72} x2={70} y2={57} />
        <line x1={70} y1={57} x2={52} y2={46} />
        {/* FOOT TICK: toe kicks UP off the block edge */}
        <line x1={52} y1={46} x2={48} y2={37} />
        {/* neck + head, dropped near the floor */}
        <line x1={140} y1={98} x2={150} y2={102} />
        <circle cx={155} cy={106} r={7} />
        {/* joint dots */}
        <circle cx={140} cy={98} r={2.5} fill="currentColor" stroke="none" />
        <circle cx={152} cy={102} r={2.5} fill="currentColor" stroke="none" />
        <circle cx={96} cy={72} r={2.5} fill="currentColor" stroke="none" />
        <circle cx={70} cy={57} r={2.5} fill="currentColor" stroke="none" />
      </g>
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      <g className="pose-a">
        ...
        {/* FLAT body plank: shoulder -> hip -> knee -> ankle (level torso) */}
        <line x1={124} y1={76} x2={90} y2={78} />
        <line x1={90} y1={78} x2={64} y2={82} />
        <line x1={64} y1={82} x2={42} y2={86} />
        {/* FOOT TICK: toe kicks UP off the ankle (clearly angled away from the body
            line) so the leg reads as a leg, not a third arm */}
        <line x1={42} y1={86} x2={34} y2={79} />
      ...
      <g className="pose-b">
        ...
        {/* FOOT TICK: toe kicks UP off the ankle */}
        <line x1={42} y1={94} x2={34} y2={87} />
  ...
  return (
    ...
    >
      ...
      {/* pose A — top: flat plank, both arms supporting. Near (working) arm
          ...
          the near hand, so the unloaded side reads instantly. Head lifted HIGH and
          well FORWARD (center 144,56) so it sits a clear ~12px above the far-arm
          line and is offset in x from the pose-b head (no crossfade double-head). */}
      <g className="pose-a">
        ...
        {/* FOOT TICK: toe kicks UP off the ankle */}
        <line x1={38} y1={82} x2={30} y2={75} />
        {/* neck + head: lifted HIGH and forward, clear above the far-arm line */}
        <line x1={118} y1={72} x2={136} y2={62} />
        <circle cx={144} cy={56} r={7} />
        {/* joint dots: shoulder, hip, knee */}
      ...
      {/* pose B — body sunk over the bent WORKING arm; FAR arm dead-straight onto
          the TALL block (the assist signature: the propped, still-high hand). Head
          tucks up-and-BACK over the shoulder (center 104,80) so (a) it is clear of
          the far arm, which sweeps off to the right, and (b) it sits far from the
          pose-a head (144,56) — ~40px away — so the crossfade never stacks two
          heads on one line. */}
      <g className="pose-b">
        ...
        {/* FOOT TICK: toe kicks UP off the ankle */}
        <line x1={38} y1={92} x2={30} y2={85} />
        {/* neck + head: tucked up-and-back over the shoulder, away from the far arm */}
        <line x1={118} y1={94} x2={109} y2={86} />
