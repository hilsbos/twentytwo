...
const PUSH: Exercise[] = [
  ...
  },
  {
    ...
    note: 'Your shoulder builder and the road to a handstand.',
    main: true,
  },
  {
    key: 'chair_dips',
    ...
    note: 'Two chairs or a bed edge. Triceps + lower chest.',
    main: true,
  },
  {
    key: 'hollow_hold',
...
const LEGS: Exercise[] = [
  ...
  },
  {
    ...
    note: 'Band above knees. Squeeze hard at the top for a 2-count.',
    main: true,
  },
  {
    key: 'reverse_lunge',
  ...
  {
    key: 'band_walks',
    name: 'Band walks + leg raises',
    sets: 2,
    unit: 'reps',
    range: [15, 15],
    path: ['Lateral+monster walk+leg raises'],
    note: 'Glute + core finisher with the band.',
    main: false,
  },
];
...
const PULL: Exercise[] = [
  {
    ...
    note: 'Folded towel around a door handle, lean back, pull chest to hands. Keep the body in one line.',
    main: true,
  },
  {
    key: 'band_pull_apart',
    ...
    note: 'Rear delts — the posture muscles a desk destroys.',
    main: true,
  },
  {
    key: 'superman_ytw',
    ...
    note: 'Lower back + mid-traps. Zero equipment.',
    main: true,
  },
  {
    key: 'curls_plank',
    ...
    note: 'Curls 10–15 + plank 30–60s. Biceps + core.',
    main: false,
  },
];
...
export const DAYS: Record<DayType, Day> = {
  push: {
    ...
    title: 'Push day',
    focus:
      'Pressing strength and a fuller chest and shoulders. Pause 1–2 reps short of failure on every set; lower for a 3-count.',
    exercises: PUSH,
  },
  legs: {
    type: 'legs',
  ...
  pull: {
    ...
    title: 'Pull day',
    focus:
      'The one day that needs a setup. Anchor a sturdy door, table, or a doorway bar. This is what builds a complete, upright physique.',
    exercises: PULL,
  },
  flex: {
    type: 'flex',
